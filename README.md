...
```text
Business Analyst portfolio case study for an internship recruitment management system, including BRD, SRS, stakeholder analysis, AS-IS/TO-BE workflows, user stories, acceptance criteria, wireframes, test scenarios, and RTM.
```

## 10. Suggested CV Description

**InternshipHub - Business Analyst Portfolio Project**  
Created an end-to-end Business Analyst case study for an internship recruitment management system. Documented stakeholder analysis, AS-IS and TO-BE processes, BRD, SRS, user stories, acceptance criteria, wireframe specifications, test scenarios, and a requirement traceability matrix.

## 11. Interview Pitch

I built InternshipHub as a Business Analyst portfolio project to understand the full requirement lifecycle in a software project. I started from the business problem, identified stakeholders, analyzed the current recruitment process, designed the future workflow, and documented the solution through BRD, SRS, user stories, acceptance criteria, wireframes, test scenarios, and a traceability matrix.

This project helped me understand how a BA connects business stakeholders, developers, QA engineers, and product goals.
...
git init
git add .
git commit -m "Initial BA portfolio project: InternshipHub"
git branch -M main
git remote add origin https://github.com/nguyencuong335/internshiphub-ba-portfolio.git
git push -u origin main
```

If the remote repository already exists and you need to update it later:

```powershell
git add .
git commit -m "Update BA portfolio artifacts"
git push
```

## 13. Project Status

Current status: **Documentation completed for BA portfolio version 1.0**

Next possible improvements:

- Add Figma wireframes.
- Add clickable prototype.
- Add simple frontend demo.
- Add Jira-style backlog export.
- Add Vietnamese version of BA artifacts.
